...
public class AccountManagementController : ControllerBase
{
    ...
    public async Task<IActionResult> DeactivateAccount([FromBody] DeactivateAccountRequest command)
    {
    ...
    public async Task<IActionResult> DeleteAccount([FromBody] DeactivateAccountRequest command)
    {
        var userId = User.GetBusinessId();
