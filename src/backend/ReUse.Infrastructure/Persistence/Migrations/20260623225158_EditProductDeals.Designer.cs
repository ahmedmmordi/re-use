...
namespace ReUse.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260623225158_EditProductDeals")]
    partial class EditProductDeals
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReUse.Domain.Entities.ProductDeal", b =>
                {
                    ...
                    b.HasOne("ReUse.Domain.Entities.User", "Proposer")
                        .WithMany()
                        .HasForeignKey("ProposerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ReUse.Domain.Entities.User", "Receiver")
                        .WithMany()
