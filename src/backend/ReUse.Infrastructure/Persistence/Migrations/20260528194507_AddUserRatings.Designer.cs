...
namespace ReUse.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260528194507_AddUserRatings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReUse.Domain.Entities.UserRating", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("user_ratings", null, t =>
                        {
                            t.HasCheckConstraint("CK_UserRating_Rater_Not_Ratee", "\"RaterUserId\" <> \"RateeUserId\"");

                            t.HasCheckConstraint("CK_UserRating_Stars_1_5", "\"Stars\" BETWEEN 1 AND 5");
                        });
                });
